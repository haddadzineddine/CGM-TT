...
import org.cgm.service.VisiteService;
...
public class VisiteResource {
    ...
    @APIResponse(responseCode = "404", description = "Visite not found", content = @Content(mediaType = APPLICATION_JSON, schema = @Schema(implementation = Response.class, type = OBJECT)))
